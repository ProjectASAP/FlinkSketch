...
import dev.projectasap.flinksketch.sketches.datasketches.DataSketchItemsSketch;
...
/** Memory comparison example demonstrating DataSketches ItemsSketch vs exact TopK. */
public class DataSketchItemsMemoryExample {
  public static void main(String[] args) throws Exception {
    ...
    DataSketchItemsSketch itemsSketch = createItemsSketch();
    ...
    DataStream<PrecomputedOutput> sketchStream =
        inputStream
            ...
            .window(TumblingEventTimeWindows.of(Time.seconds(5)))
            .aggregate(
                itemsSketch, new KeyedWindowProcessor(sketchConfig, "insertion", "items", false));
    ...
    env.execute("DataSketch ItemsSketch Memory Comparison Example");
  }
  ...
  private static DataSketchItemsSketch createItemsSketch() {
    Map<String, String> params = new HashMap<>();
    params.put("maxMapSize", "1024");
    return new DataSketchItemsSketch("items", params);
  }
